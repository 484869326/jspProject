          ...
          <div class="cart-table card mb-3">
            ...
            <form action="" method="POST">
              <table class="table mb-0">
                <tbody>
                <%
                String sql = "SELECT * FROM good t1 inner join category t2 on t1.typeid=t2.typeid";
	                    ...
	                    <td>
	                      ...
	                      <%
	                      	if(currentCommodity.getState()){
	                      		%>
	                      			<a class="btn btn-warning btn-sm" href="upordown?state=1&cid=<%=currentCommodity.getGoodid() %>">下架</a>
	                      		<%
	                      	}else{
	                      		%>
	                      			<a class="btn btn-info btn-sm" href="upordown?state=0&cid=<%=currentCommodity.getGoodid() %>">上架</a>
	                      		<%
	                      	}
