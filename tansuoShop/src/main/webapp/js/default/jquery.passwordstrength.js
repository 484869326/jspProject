    ...
    $.fn.passwordStrength = function (options) {
        ...
        $(this).keyup(function (event) {
            ...
            if (password.length == 0) {
                ...
                if (score < 50) {
                    $('#password-score').html('太弱了 <span class="icofont-exclamation-tringle"></span>');
                    ...
                    $('#password-score').html('还行吧 <span class="icofont-check"></span>');
                    ...
                    $('#password-score').html('很好了哦 <span class="icofont-check"></span>');
                    ...
                    $('#password-score').html('太棒了 <span class="icofont-check"></span>');
                    $('#password-recommendation').html('');
                    $('#password-progress').removeClass();
